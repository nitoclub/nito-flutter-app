...
void main() {
  final FeatureFrontendSettingPlatform initialPlatform =
      FeatureFrontendSettingPlatform.instance;

  test('$MethodChannelFeatureFrontendSetting is the default instance', () {
    expect(
        initialPlatform, isInstanceOf<MethodChannelFeatureFrontendSetting>());
  });

  test('getPlatformVersion', () async {
    FeatureFrontendSetting featureFrontendSettingPlugin =
        FeatureFrontendSetting();
    MockFeatureFrontendSettingPlatform fakePlatform =
        MockFeatureFrontendSettingPlatform();
