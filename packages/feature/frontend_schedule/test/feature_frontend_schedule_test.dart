...
void main() {
  final FeatureFrontendSchedulePlatform initialPlatform =
      FeatureFrontendSchedulePlatform.instance;

  test('$MethodChannelFeatureFrontendSchedule is the default instance', () {
    expect(
        initialPlatform, isInstanceOf<MethodChannelFeatureFrontendSchedule>());
  });

  test('getPlatformVersion', () async {
    FeatureFrontendSchedule featureFrontendSchedulePlugin =
        FeatureFrontendSchedule();
    MockFeatureFrontendSchedulePlatform fakePlatform =
        MockFeatureFrontendSchedulePlatform();
